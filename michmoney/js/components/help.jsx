    ...
    return (
        <div className="flex flex-col p-10 bg-gray">
            ...
            <div className="max-w-md fira">
                <p>
                    Using MichMoney is easy! Simply click on the sidebar to navigate to the page you want to go to.
                </p>
                <p>
                ...
                <p>
                    Click on the "Optimize" button and MichMoney will generate an optimized portfolio using the selected algorithm.
