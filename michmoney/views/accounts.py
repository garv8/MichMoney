...
import flask
import michmoney
from michmoney.api.auth import (
    check_user_exists,
    check_email_exists,
    check_user_password,
    generate_api_key,
...
@michmoney.app.route("/accounts/register/", methods=["POST"])
def accounts_create():
...
@michmoney.app.route("/accounts/login/", methods=["POST"])
def login():
    """Login a user."""
...
@michmoney.app.route("/accounts/logout/", methods=["GET", "POST"])
def logout():
    """Logout a user."""
...
@michmoney.app.route("/accounts/delete/", methods=["GET", "POST"])
def accounts_delete():
